<?php
	...
	$tmp_file_path = "uploaded_files/" . trim($filename_1);
	...
	if(move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $tmp_file_path)) {
	    ...
	    $row_array['message'] = "File ". $tmp_file_path . " upload succesfully. Thank you " . $name . " !!! Filename: " . $filename . " // " . $filename_1;
